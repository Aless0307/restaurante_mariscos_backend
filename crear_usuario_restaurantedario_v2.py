#!/usr/bin/env python3
"""
Script para crear el usuario 'restaurantedario' directamente en MongoDB
"""
import sys
import os
...
# Contexto de hashing compatible
...
def crear_usuario_restaurantedario():
    ...
    try:
        ...
        if usuario_existente:
            ...
            nueva_password_hash = pwd_context.hash("Dario6219$"[:72])
        ...
        password_hash = pwd_context.hash("Dario6219$"[:72])
