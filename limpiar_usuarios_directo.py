...
VERSIÓN DIRECTA (sin confirmación)
"""
import sys
import os
...
def limpiar_usuarios_directo():
    ...
    try:
        ...
        print()
        print("🗑️  Eliminando usuarios excepto: restaurantedario@restaurante.com")
